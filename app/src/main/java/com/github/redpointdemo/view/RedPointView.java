...
public class RedPointView extends FrameLayout {
    ...
    private void initView(Context context,AttributeSet attrs) {
        ...
        String text = ta.getString(R.styleable.RedPointView_text);


        mCurPoint = new PointF();//绘制当前触摸的点
        mCenterPoint = new PointF();//中心固定的点
        ...
        mDragTextView = new TextView(getContext());//可拖动TextView
        ...
        if (text.equals("")){
            mDragTextView.setText("");
        }else{
            mDragTextView.setText(text);
        }
        mExplodeImage = new ImageView(getContext());//爆炸动画ImageView
